...
import { Home, Build, HelpCenter, Mail, MoreHoriz } from "@mui/icons-material"
    ...
    <>
      ...
      >
        ...
        >
          ...
          <BottomNavigationAction label="Schaden" icon={<Build />} />
          <BottomNavigationAction label="Anliegen" icon={<HelpCenter />} />
          <BottomNavigationAction label="Postfach" icon={<Mail />} />
          <BottomNavigationAction label="Mehr" icon={<MoreHoriz />} />
        </BottomNavigation>
      </Paper>
